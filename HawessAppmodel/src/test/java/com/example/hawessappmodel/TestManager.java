...
class TestManager {
    ...
    void setUp() throws Exception {
        ...
        constantine.addAddress(new Address(1,30.04589, 6.3802, "street", "constantine", "25000" , "Algeria"));
        mila.addAddress(new Address(2,30.04589, 6.3802, "street", "mila", "25000" , "Algeria"));
        alger.addAddress(new Address(3,30.04589, 6.3802, "street", "alger", "25000" , "Algeria"));
        annaba.addAddress(new Address(4,30.04589, 6.3802, "street", "annaba", "25000" , "Algeria"));
        oran.addAddress(new Address(5,30.04589, 6.3802, "street", "oran", "25000" , "Algeria"));
        ...
        //add visit
        Visit visit01 = new Visit("photo01FilePath", 4, "great place", new GregorianCalendar(2022, Calendar.NOVEMBER, 21).getTime(),hadir,constantine);
